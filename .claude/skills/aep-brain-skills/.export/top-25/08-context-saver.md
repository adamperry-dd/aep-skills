---
name: context-saver
description: Save exploration findings and context to persistent storage. Use when making important discoveries, completing work phases, or preserving state for future sessions.
---

# Context Saver Skill

This skill enables Claude Capsule Kit to save discoveries to persistent storage.
...
2. Prints: "🧠 Claude Capsule Kit MEMORY LOADED: Previous exploration findings available"
