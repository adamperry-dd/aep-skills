---
name: fact-check
description: Verify technical accuracy of JavaScript documentation. Use when fact-checking code examples, validating MDN/ECMAScript compliance, reviewing concept pages, or auditing documentation for misinformation.
---
