---
name: agent-builder
description: Build and optimize AI agents with research-backed guidance. Use when creating new agents, improving agent descriptions, troubleshooting activation issues, or designing agent workflows. Provides opinionated recommendations for triggers, permissions, and architecture.
---
