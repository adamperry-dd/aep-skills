...
description: Create publication-quality scientific diagrams with smart iterative refinement. Use when creating neural network architectures, system diagrams, flowcharts, biological pathways, or scientific visualizations. Supports journal, conference, thesis, and grant quality thresholds.
