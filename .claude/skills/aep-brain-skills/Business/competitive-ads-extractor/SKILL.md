...
description: Extracts and analyzes competitors' ads from ad libraries (Facebook, LinkedIn, etc.). Use when researching competitor ad strategies, finding ad inspiration, analyzing successful messaging patterns, or planning ad campaigns. Helps understand market positioning and creative approaches.
---
