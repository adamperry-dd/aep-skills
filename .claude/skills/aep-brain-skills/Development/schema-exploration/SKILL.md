...
description: Discover and understand database structure. Use when exploring tables, columns, relationships, or understanding schema organization before writing queries.
---
