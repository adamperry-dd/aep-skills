---
name: query-writing
description: Write and execute SQL queries from simple to complex. Use when building single-table queries, multi-table JOINs, aggregations, or answering data questions with SQL.
---
