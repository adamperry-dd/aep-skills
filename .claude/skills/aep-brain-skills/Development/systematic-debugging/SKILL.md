...
description: Four-phase debugging framework for root cause analysis. Use when encountering bugs, test failures, or unexpected behavior. Investigates before attempting fixes.
---
