...
description: Display progress dashboard with phase completion and blocked tasks. Use when checking implementation status, reviewing project progress, or identifying blocked work. Requires tasks.md file.
license: MIT
