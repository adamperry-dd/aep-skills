...
description: Detect system resources (CPU, GPU, memory, disk) for computational tasks. Use when planning resource-intensive analysis, training ML models, or deciding between parallel processing, GPU acceleration, or out-of-core computing approaches.
---
